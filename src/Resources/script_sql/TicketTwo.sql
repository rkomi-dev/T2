...
-- 1. Tabella Utente (MySQL 8.4 supporta pienamente VARCHAR e indici standard)
CREATE TABLE Utente (
	nome VARCHAR(100) NOT NULL,
	cognome VARCHAR(100) NOT NULL,
    email VARCHAR(191) PRIMARY KEY, -- 191 è ottimale per indici UTF8MB4
